...
namespace ExampleScenes.Algorithm.MarchingCube
{
    public class MarchingCube : SingletonMono<MarchingCube>
    {
        ...
        void Refresh()
        {
            ...
            foreach (var cube in m_CubePool.Values)
            {
                ...
                var rotation = UMath.m_Rotate3DCW[orientation];
    ...
    public static class MarchingCubeDefines
    {
        ...
        public static Qube<Int3> kQubeRelativeGrids = new Qube<Int3>(
            Int3.Zero, Int3.Forward, Int3.Forward + Int3.Right, Int3.Right,
            Int3.Up, Int3.Up + Int3.Forward, Int3.Up+Int3.Forward + Int3.Right, Int3.Up + Int3.Right);
        public static Qube<Int3> kGridRelativeQubes=new Qube<Int3>(-Int3.Forward-Int3.Right,-Int3.Right,Int3.Zero,-Int3.Forward
        ,-Int3.Forward-Int3.Right-Int3.Up,-Int3.Right-Int3.Up,Int3.Zero-Int3.Up,-Int3.Forward-Int3.Up);
