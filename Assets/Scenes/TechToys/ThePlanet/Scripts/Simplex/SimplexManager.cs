...
namespace TechToys.ThePlanet.Simplex
{
    ...
    public class SimplexManager : MonoBehaviour,IPCGControl
    {
        ...
        private static readonly EVertexAttributeFlags kOutputVertexData = UEnum.CreateFlags(EVertexAttributeFlags.UV0,EVertexAttributeFlags.Color);
        ...
        public void OnDrawGizmos()
        {
            ...
            if(m_DrawVoxels)
                foreach (var voxel in m_Voxels.Values)
                {
                    ...
                    UGizmos.DrawString(output,voxel.position, 0f);
                }
        }
    #endif
    }
