    ...
    public static class IExtends_Extension
    {
        ...
        public static bool RayIntersect(this IExtents _entity, GRay _ray)
        {
            ...
            switch (_entity.kExtentData.type)
            {
                ...
                case EGeometryType.Box: return UGeometry.Intersect.Eval(localRay, _entity.kExtentData.boxBounds);
                case EGeometryType.Sphere: return UGeometry.Intersect.Eval(localRay,_entity.kExtentData.sphericalBounds);
            }
        }
