...
namespace Dome
{
    ...
    public class DomeCell : APoolTransform<int>
    {
        ...
        public void PopulateMesh()
        {
            ...
            var innerQuad = outerQuad.Shrink(m_Environment.m_Shape.m_Shrink) + kfloat3.up * m_Environment.m_Shape.m_Upward;
            outerQuad -= center;
            innerQuad -= center;
            ...
            int indexStart = 0;        
            UPolygon.ApplyQuadIndexes(indexes,indexStart + 0,vertexStart+4,vertexStart+5,vertexStart+6,vertexStart+7);      //Top
            UPolygon.ApplyQuadIndexes(indexes,indexStart + 2,vertexStart+0,vertexStart+1,vertexStart+5,vertexStart+4);      //Bottom
            UPolygon.ApplyQuadIndexes(indexes,indexStart + 4,vertexStart+1,vertexStart+2,vertexStart+6,vertexStart+5);      //Left
            UPolygon.ApplyQuadIndexes(indexes,indexStart + 6,vertexStart+2,vertexStart+3,vertexStart+7,vertexStart+6);      //Forward   
            UPolygon.ApplyQuadIndexes(indexes,indexStart + 8,vertexStart+3,vertexStart+0,vertexStart+4,vertexStart+7);      //Right       
