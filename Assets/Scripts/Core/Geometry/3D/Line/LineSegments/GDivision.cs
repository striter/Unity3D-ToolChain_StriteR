...
namespace Runtime.Geometry.Curves.LineSegments
{
    ...
    [Serializable]
    public struct GDivisionCurve : IGeometry
    {
        public float3 begin;
        public float3 end;
        ...
        {
            var outputs = Output(out var divisions);
            ...
            Gizmos.DrawWireSphere(begin,.05f);
            Gizmos.DrawWireSphere(end,.05f);

            Gizmos.color = Color.red;
            Gizmos.DrawWireSphere(control1,.05f);
            
            Gizmos.DrawWireSphere(control2,.05f);

            Gizmos.color = Color.white;
            Gizmos.DrawLine(begin,control1);
            Gizmos.DrawLine(begin,control2);
            Gizmos.DrawLine(end,control1);
            Gizmos.DrawLine(end,control2);
