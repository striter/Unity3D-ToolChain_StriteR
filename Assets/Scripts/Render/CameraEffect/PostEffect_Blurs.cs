...
namespace Rendering.ImageEffect
{
    ...
    public class ImageEffect_Blurs : ImageEffectBase<ImageEffectParam_Blurs>
    {
        ...
        public override void ExecutePostProcessBuffer(CommandBuffer _buffer, RenderTargetIdentifier _src, RenderTargetIdentifier _dst, RenderTextureDescriptor _descriptor, ImageEffectParam_Blurs _data)
        {
