...
{
    public class PostProcess_VolumetricCloud : PostProcessComponentBase<PPCore_VolumetricCloud, PPData_VolumetricCloud>
    {
        public override bool m_IsOpaqueProcess => true;
    }

    [Serializable]
    public struct PPData_VolumetricCloud
    {
        ...
        public static readonly PPData_VolumetricCloud m_Default = new PPData_VolumetricCloud()
        {
            m_VerticalStart = 20f,
    ...
    public class PPCore_VolumetricCloud : PostProcessCore<PPData_VolumetricCloud>
    {
