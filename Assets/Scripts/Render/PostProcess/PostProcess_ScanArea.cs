...
{
    public class PostProcess_ScanArea : PostProcessComponentBase<PPCore_ScanArea, PPData_ScanArea>
    {
    ...
    public struct PPData_ScanArea
    {
        ...
        public static readonly PPData_ScanArea m_Default = new PPData_ScanArea()
        {
    ...
    public class PPCore_ScanArea:PostProcessCore<PPData_ScanArea>
    {
