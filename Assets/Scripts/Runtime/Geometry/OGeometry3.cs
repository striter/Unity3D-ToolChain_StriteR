...
namespace Geometry.Three
{
    ...
    public struct GTriangle
    {
        ...
        public Vector3 vertex0=>vertices[0];
        public Vector3 vertex1=>vertices[1];
        public Vector3 vertex2=>vertices[2];
        ...
        public GTriangle(Vector3 _vertex1, Vector3 _vertex2, Vector3 _vertex3) : this(new[] { _vertex1, _vertex2, _vertex3 }) { }
        public GTriangle(Vector3[] _vertices)
        {
            Debug.Assert(_vertices.Length == 3, "Triangles' Vertices Count Must Equals 3!");
            vertices = _vertices;
            uOffset = _vertices[1] - _vertices[0];
            vOffset = _vertices[2] - _vertices[1];
