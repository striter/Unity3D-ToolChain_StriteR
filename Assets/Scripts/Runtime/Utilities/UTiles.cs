...
namespace UTile
{
    ...
    public struct Tile
    {
        ...
        public static (ETileDirection,Tile)[] m_NearbyTiles = {(ETileDirection.Left, new Tile(-1, 0)),(ETileDirection.Right, new Tile(1, 0)),
            (ETileDirection.Top, new Tile(0, 1)),(ETileDirection.Bottom ,new Tile(0, -1))};
    ...
    public static class TileTools
    {
        ...
        public static readonly Dictionary<ETileDirection, Tile> m_DirectionAxies = new Dictionary<ETileDirection, Tile>() {
            { ETileDirection.Top,new Tile(0,1) }, { ETileDirection.Right, new Tile(1, 0) }, { ETileDirection.Bottom, new Tile(0, -1) }, { ETileDirection.Left, new Tile(-1, 0) },
            { ETileDirection.TopRight, new Tile(1, 1) }, { ETileDirection.BottomRight, new Tile(1, -1) }, { ETileDirection.BottomLeft, new Tile(-1, -1) }, { ETileDirection.TopLeft, new Tile(-1, 1) } };
