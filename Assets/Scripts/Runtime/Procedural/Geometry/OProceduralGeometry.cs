...
namespace Procedural.Geometry
{
    ...
    public struct ProceduralMeshInput
    {
        ...
        [MFoldout(nameof(meshType), EProceduralMeshType.SphereCubeSeamless)] public SeamlessCubeSphereGenerator m_SeamlessCubeGenerator;
        public static readonly ProceduralMeshInput kDefault = new ProceduralMeshInput()
        {
            ...
            m_SeamlessCubeGenerator = SeamlessCubeSphereGenerator.kDefault,
        };
        ...
        public void Output(Mesh _mesh)
        {
            ...
            switch (meshType)
            {
                ...
                case EProceduralMeshType.SphereCubeSeamless: {
                    new ProceduralMeshJob<SeamlessCubeSphereGenerator>(meshData,m_SeamlessCubeGenerator).ScheduleParallel(1,1,default).Complete();
                }break;
            }
