...
namespace Runtime
{
    public abstract class ALineRendererBase : ARuntimeRendererBase
    {
        ...
        protected abstract void PopulatePositions(Transform _transform,List<Vector3> _vertices, List<Vector3> _normals);
        protected sealed override void PopulateMesh(Mesh _mesh,Transform _transform,Transform _viewTransform)
        {
            ...
            PopulatePositions(_transform,positions, normals);
