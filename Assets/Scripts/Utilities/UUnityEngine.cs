...
public static class UUnityEngine
{
    ...
    public static Polygon[] GetPolygons(this Mesh _srcMesh,out Vector3[] verticies,out int[] triangles)
    {
        triangles = _srcMesh.triangles;
        verticies = _srcMesh.vertices;
        Polygon[] polygons = new Polygon[triangles.Length / 3];
        for(int i=0;i< polygons.Length;i++)
        {
            ...
            polygons[i] = new Polygon(verticies[triangle0],verticies[triangle1],verticies[triangle2],triangle0,triangle1,triangle2);
        }
        return polygons;
    }
}
