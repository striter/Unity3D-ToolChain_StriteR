...
namespace TAlthogrim
{
    ...
    public static class TPerlinNoise
    {
        ...
        public static double Perlin(double x,double y,double z)
        {
            ...
            temp1 = Lerp(Gradient(aaa, xf, yf, zf), Gradient(baa, xf - 1, yf, zf), u);
            temp2 = Lerp(Gradient(aba,xf,yf-1,zf),Gradient(bba,xf-1,yf-1,zf),u);
            temp3 = Lerp(temp1,temp2,v);
            temp1 = Lerp(Gradient(aab, xf, yf, zf-1), Gradient(bab, xf - 1, yf ,zf - 1), u);
            temp2 = Lerp(Gradient(abb, xf, yf - 1, zf - 1), Gradient(bbb, xf - 1, yf - 1, zf - 1),u);
            temp4 = Lerp(temp1, temp2, v);
            return (Lerp(temp3, temp4, w) + 1) / 2;
        }
