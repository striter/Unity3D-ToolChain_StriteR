...
namespace MeshFragment
{
    ...
    public static class UMeshFragment
    {
        ...
        public static void Combine(IList<IMeshFragment> _fragments,Mesh _mesh,Material[] _materialLibrary,out Material[] _embedMaterials,EVertexAttributeFlags _inputs = (EVertexAttributeFlags)int.MaxValue,IndexFormat _indexFormat = IndexFormat.UInt16)
        {
            ...
            bool normalValid = _inputs.IsFlagEnable(EVertexAttributeFlags.Normal);
            bool tangentValid = _inputs.IsFlagEnable(EVertexAttributeFlags.Tangent);
            bool uvValid = _inputs.IsFlagEnable(EVertexAttributeFlags.UV0);
            bool colorValid = _inputs.IsFlagEnable(EVertexAttributeFlags.Color);
