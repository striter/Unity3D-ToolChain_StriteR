...
namespace TEditor
{
    ...
    public class MeshEditorHelperBase
    {
        ...
        protected static int RayDirectedTriangleIntersect(GMeshPolygon[] _polygons, Vector3[] _verticies, Ray _ray, out Vector3 hitPoint, out GDirectedTriangle hitTriangle)
        {
