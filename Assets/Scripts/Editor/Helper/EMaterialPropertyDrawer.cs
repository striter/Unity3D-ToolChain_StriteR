...
namespace TEditor
{
    ...
    public class FoldoutDrawer: MaterialPropertyDrawerBase
    {
        protected readonly string[] m_Keywords;
        public FoldoutDrawer(string[] _keywords)  {   m_Keywords = _keywords; }
        public FoldoutDrawer(string _kw1) : this(new string[] { _kw1 }) { }
        public FoldoutDrawer(string _kw1, string _kw2) : this(new string[] { _kw1, _kw2 }) { }
        public FoldoutDrawer(string _kw1, string _kw2,string _kw3) : this(new string[] { _kw1, _kw2 ,_kw3}) { }
        public FoldoutDrawer(string _kw1, string _kw2,string _kw3,string _kw4) : this(new string[] { _kw1, _kw2 ,_kw3,_kw4}) { }
        ...
        bool CheckAvailable(MaterialProperty prop)
        {
