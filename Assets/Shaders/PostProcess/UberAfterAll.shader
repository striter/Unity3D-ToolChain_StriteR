Shader "Hidden/PostProcess/UberAfterAll"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half3 VHS(half3 col,float2 uv)
            {
                ...
                #endif
                col=lerp(col,_GrainColor,grain);
                #endif
            ...
            half3 ColorGrading(half3 col)
			{
            	half3 targetCol=col;
					...
					targetCol=SampleLUT(_LUTTex,sampler_LUTTex,_LUTTex_TexelSize,_LUTCellCount,lutCol)+offset;
				#endif
					...
					targetCol = mul(targetCol,mixMatrix);
				#endif
